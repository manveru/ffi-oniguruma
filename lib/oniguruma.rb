...
module Oniguruma
  ...
  class ORegexp
    def initialize(pattern, given_options = {})
      @pattern, @options = pattern.to_s, options

      pat_ptr  = FFI::MemoryPointer.from_string(@pattern)
      pat_len  = @pattern.bytesize
      options  = @options[:options]
      encoding = @options[:encoding]
      syntax   = @options[:encoding]
    end
